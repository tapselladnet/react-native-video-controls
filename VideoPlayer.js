...
export default class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      doubleTapToResizeMode: this.props.doubleTapToResizeMode,
  ...
  _onScreenTouch() {
    ...
    if (delta < 300 && this.state.doubleTapToResizeMode) {
  ...
  _onLoaderUnmountRequested() {
    if (
      ...
      typeof this.props.onLoaderUnmountRequested === 'function'
    ) {
      this.props.onLoaderUnmountRequested();
    }
  }
  ...
  _onLoaderMountRequested() {
    if (
      ...
      typeof this.props.onLoaderMountRequested === 'function'
    ) {
      this.props.onLoaderMountRequested();
    }
  }
   ...
   */
  renderTopControls() {
    if (!this.state.controlsShouldBeRendered) {
      return null;
    }
   ...
   */
  renderLoader() {
    if (this.state.controlsShouldBeRendered && this.state.loading) {
      return (
  ...
  renderError() {
    if (this.state.controlsShouldBeRendered && this.state.error) {
      return (
